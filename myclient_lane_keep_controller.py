...
def waypoint_following_controller():
    #############################################
    # Load Waypoints
    #############################################
    # Opens the waypoint file and stores it to "waypoints"
    ...
    #print(waypoints)
    controller = controller2d.Controller2D(waypoints, 'MPC')

    return controller


def apply_control(world, throttle, steer, brake):
    control = carla.VehicleControl()
    control.throttle = throttle
    control.steer = steer
    control.brake = brake
